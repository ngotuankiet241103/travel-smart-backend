package com.travelsmart.review_service.exception;
...
public enum ErrorCode {
    ...
    REVIEW_NOT_FOUND(1004,"Review not found",HttpStatus.NOT_FOUND),
    IMAGE_NOT_FOUND(1004,"Image not found",HttpStatus.NOT_FOUND),
    ...
    MIN_RATING_INVALID(1003,"Rating must be greater than 0 or equals 1",HttpStatus.BAD_REQUEST),
    MAX_RATING_INVALID(1003,"Rating max is 5",HttpStatus.BAD_REQUEST),
    CONTENT_INVALID(1003,"Content must be not empty",HttpStatus.BAD_REQUEST),
    LOCATION_INVALID(1003,"Location must be not null",HttpStatus.BAD_REQUEST),
