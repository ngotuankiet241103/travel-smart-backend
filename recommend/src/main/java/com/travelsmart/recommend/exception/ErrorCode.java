...
public enum ErrorCode {
    ...
    PLACE_INVALID(1003, "Place is not valid", HttpStatus.BAD_REQUEST),
    CURRENT_LAT_INVALID(1003, "Current lat must be not null", HttpStatus.BAD_REQUEST),
    CURRENT_LON_INVALID(1003, "Current lon must be not empty", HttpStatus.BAD_REQUEST),
