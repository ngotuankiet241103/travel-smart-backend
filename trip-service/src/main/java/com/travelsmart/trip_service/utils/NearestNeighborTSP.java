...
public class NearestNeighborTSP {
    ...
    public static Map<String,Object> planAllDay(DistanceResponse[][] distanceMatrix, boolean[] visited, double[] visitTimes, double maxHoursPerDay,int currentLocation) {
        int n = distanceMatrix.length;
        List<Integer> dailyItinerary = new ArrayList<>();
        int startLocation = 0;
        double totalHours = 0;
